...
import { new_password, new_user } from "./model/forms";
...
[
   ...
   ()=>right_panel( my_cookie.clinic? my_cookie.clinic: "Altamed", "senior_admin"),
   ()=>massage_panel(),
      ...
      [
         ...
         [
            ...
            [
               ...
               p({className:'name-role'},"Cтарший администратор"),
